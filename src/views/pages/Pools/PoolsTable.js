                        ...
                        <Row>
                          <Col> <Table borderless>
                            ...
                            <tr>
                              ...
                              <th className="output-card text-right">218.988 SPARTA</th>
                            </tr>
                            <tr>
                              <td className="output-card">Total depth</td>
                              <th className="output-card text-right">1.000.000 BNB </th>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              ...
                              <th className="output-card text-right">148.655</th>
                            </tr>
                            <tr>
                              <td className="output-card">
                                Fee
                              ...
                              <th className="output-card text-right">2.52 SPARTA</th>
                            </tr>
                            <tr>
                              <td className="output-card">
                                Dividend
