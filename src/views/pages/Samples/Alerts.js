...
import {Button, Card, CardBody, CardText, Row, Col, UncontrolledAlert} from "reactstrap";
    ...
    const warningWithConfirmMessage = () => {
        setAlert(
            <ReactBSAlert
                ...
                btnSize=""
            >
                Be aware that if you can lose your assets if you don't know what you are doing!
            </ReactBSAlert>
        );
    };
    ...
    const successDelete = () => {
        setAlert(
            <ReactBSAlert
                ...
                btnSize=""
            >
                0xce2fd7544e0b2cc94692d4a704debef7bcb61328 <br/><br/>Copy<span data-notify="icon" className="bd-icons icon-single-copy-04" />
            </ReactBSAlert>
        );
    };
    const cancelDetele = () => {
