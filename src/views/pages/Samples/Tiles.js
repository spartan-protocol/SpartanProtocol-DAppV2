            ...
            <div className="content">
                <Card className="card-body">
                    ...
                    <Col md={12}>
                        <Row>
                            <Col md="2">
                                <h2><img className="mr-2" src={bnb} alt="Logo"/>BNB</h2>
                            </Col>
                            <Col md="2">
                                <h7>APY</h7>
                                <br/>
                            ...
                            <Col sm="0">
                                ...
                                <Button type="Button" className="btn btn-primary">Exchange
                                </Button>
                            </Col>
                        </Row>
                    </Col>
                            ...
                            <Card>
                                <CardHeader role="tab">
                                    <a
                                        ...
                                        <Row>
                                            <Col md="9">
                                                <h3><img className="mr-2" src={bnb_sparta} alt="Logo" height="32"/>BNB-SPARTA
                                            ...
                                            <Col className="ml-auto" md="2">
                                                ...
                                                <h3>$1204.00 <accentcurrency>USD</accentcurrency></h3>
                                ...
                                <Card className="card-body">
                                    <Collapse role="tabpanel" isOpen={openedCollapseThree}>
                                        <CardBody>
                                            <Row>
                                                <Col md="2">
                                                    <titlecard className="mb-4">Total LP Tokens
                                                        <i className="icon-small icon-info icon-dark ml-2"/></titlecard>
                                                    <h6 className="text-muted mr-2"><img className="mr-2"
                                                                                         src={coin_sparta} alt="Logo"/>SPARTA
                                                    </h6>
                                                    <h6 className="text-muted"><img className="mr-2" src={coin_bnb}
                                                                                    alt="Logo"/>BNB</h6>
                                                </Col>
                                                <Col md="2">
                                                    <titlecard className="mb-4"><br/>
                                                    </titlecard>
                                                    <titlecard>210.45</titlecard>
                                                    <titlecard>5.76</titlecard>
                                                </Col>
                                                <Col md="2">
                                                    <titlecard className="mb-4">Add & Remove<i
                                                        className="icon-small icon-info icon-dark ml-2"/></titlecard>
                                                    <h6 className="text-muted"><img className="mr-2" src={coin_sparta}
                                                                                    alt="Logo"/>SPARTA</h6>
                                                    <h6 className="text-muted"><img className="mr-2" src={coin_bnb}
                                                                                    alt="Logo"/>BNB</h6>
                                                </Col>
                                                ...
                                                <Col md="2">
                                                    <titlecard className="mb-4">Gains<i
                                                        className="icon-small icon-info icon-dark ml-2"/></titlecard>
                                                    <h6 className="text-muted"><img className="mr-2" src={coin_sparta}
                                                                                    alt="Logo"/>SPARTA</h6>
                                                    <h6 className="text-muted"><img className="mr-2" src={coin_bnb}
