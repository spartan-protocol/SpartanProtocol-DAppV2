                          ...
                          <Row>
                            <Col md="8">
                              ...
                              <p className="description">
                                ...
                                <a href="./">link</a>. You can choose form..,
                            ...
                            <Col md="4">
                              <div>
                                <img
                                  alt="..."
                                  src={
                                    require('../../../assets/img/picto-synthetics-small.svg')
                                      .default
                                  }
                                />
                              </div>
                        ...
                        <div className="instruction">
                          <Row>
                            <Col md="8">
                              ...
                              <p className="description">
                                This is a second step at <a href="./">link</a>
                                Take me there
                              </p>
                            </Col>
                            <Col md="4">
                              <div>
                                <img
                                  alt="..."
                                  src={
                                    require('../../../assets/img/picto-lending-small.svg')
                                      .default
                                  }
                                />
                              </div>
