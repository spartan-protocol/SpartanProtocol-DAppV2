...
describe("Pricing actions", () => {
    ...
    test("should get the base pp in token", async () => {
        ...
        expect(dispatchMock.mock.calls[0][1].type).toBe(Types.GET_BASE_P_PIN_TOKEN); 
    });
    ...
    test("should get the token pp in value", async () => {
        ...
        console.log(dispatchMock.mock.calls[0][1]);
        expect(dispatchMock.mock.calls[0][1].payload).not.toBeUndefined();
        expect(dispatchMock.mock.calls[0][1].type).toBe(Types.GET_TOKEN_P_PIN_BASE); 
    });
    ...
    test("should get value in base", async () => {
        ...
        console.log(dispatchMock.mock.calls[0][1]);
        expect(dispatchMock.mock.calls[0][1].payload).not.toBeUndefined();
        expect(dispatchMock.mock.calls[0][1].type).toBe(Types.GET_VALUE_IN_BASE); 
    });
    ...
    test("should get value in token", async () => {
        ...
        console.log(dispatchMock.mock.calls[0][1]);
        expect(dispatchMock.mock.calls[0][1].payload).not.toBeUndefined();
        expect(dispatchMock.mock.calls[0][1].type).toBe(Types.GET_VALUE_IN_TOKEN); 
    });
});