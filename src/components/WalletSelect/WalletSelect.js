...
const WalletSelect = (props) => {
  ...
  const getAsset = (tokenAddress) =>
    poolFactory.finalLpArray?.filter((i) => i.tokenAddress === tokenAddress)[0]
                  ...
                  <TabContent className="tab-space" activeTab={horizontalTabs}>
                    <TabPane tabId="assets">
                      <Row className="mt-3 mb-3">
                        <Col xs="9" md="9">
                          <p className="text-card">{t('wallet')}</p>
                        </Col>
                        <Col xs="3" md="3">
                    ...
                    <TabPane tabId="lp">
                      {poolFactory.finalLpArray?.filter(
                        ...
                        <Row className="my-3">
                          <Col xs="9" md="9">
                            <p className="text-card">Staked</p>
                          </Col>
                          <Col xs="3" md="3">
                            <p className="text-card float-right mr-1">
                              Actions
                      ...
                      {poolFactory.finalLpArray?.filter(
                        ...
                        <Row className="my-3">
                          <Col xs="9" md="9">
                            <p className="text-card">Bonded</p>
                          </Col>
                          <Col xs="3" md="3">
                            <p className="text-card float-right mr-1">
                              Actions
