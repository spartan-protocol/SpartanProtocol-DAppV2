...
export const getBondClaimable = async (bondAddress, member, asset) => {
  ...
  const result = await contract.callStatic.calcClaimBondedLP(member, asset)
  console.log(result)
  return result
}
...
export const getBondMemberDetails = async (bondAddress, member, asset) => {
  const contract = getOldBondContract(bondAddress)
  const result = await contract.callStatic.getMemberDetails(member, asset)
  console.log(result)
  return result
}
...
export const getBondSpartaRemaining = async () => {
  ...
  const result = await contract.balanceOf(BOND_ADDR) // doesnt need callStatic
...
export const bondDeposit = async (asset, amount) => {
  ...
  const result = await contract.deposit(asset, amount, {
    gasPrice: gPrice,
    gasLimit: gLimit,
  })
  console.log(result)
...
export const bondClaimLock = async (asset) => {
  ...
  const result = await contract.claimAndLock(asset, {
    gasPrice: gPrice,
    gasLimit: gLimit,
  })
  console.log(result)
...
export const getBondProposalCount = async () => {
  const contract = getBondContract()
  const result = await contract.callStatic.proposalCount()
  console.log(result)
  return result
}
...
export const getBondCoolOffPeriod = async () => {
  const contract = getBondContract()
  const result = await contract.callStatic.coolOffPeriod()
  console.log(result)
  return result
}
...
export const bondProposalMintBond = async () => {
  ...
  const result = await contract.newActionProposal('MINT', {
    gasPrice: gPrice,
    gasLimit: gLimit,
  })
  console.log(result)
...
export const bondProposalListAsset = async (asset) => {
  ...
  const result = await contract.newAddressProposal(asset, 'LIST', {
    gasPrice: gPrice,
    gasLimit: gLimit,
  })
  console.log(result)
...
export const bondProposalDelistAsset = async (asset) => {
  ...
  const result = await contract.newAddressProposal(asset, 'DELIST', {
    gasPrice: gPrice,
    gasLimit: gLimit,
  })
  console.log(result)
...
export const bondProposalVote = async (proposalID) => {
  ...
  const result = await contract.voteProposal(proposalID, {
    gasPrice: gPrice,
    gasLimit: gLimit,
  })
  console.log(result)
...
export const bondProposalFinalize = async (proposalID) => {
  ...
  const result = await contract.finaliseProposal(proposalID, {
    gasPrice: gPrice,
    gasLimit: gLimit,
  })
  console.log(result)
...
export const bondProposalReplace = async (oldProposalID, newProposalID) => {
  ...
  const result = await contract.cancelProposal(oldProposalID, newProposalID, {
    gasPrice: gPrice,
    gasLimit: gLimit,
  })
  console.log(result)
...
export const bondProposalRecount = async (proposalID) => {
  ...
  const result = await contract.countVotes(proposalID, {
    gasPrice: gPrice,
    gasLimit: gLimit,
  })
  console.log(result)
