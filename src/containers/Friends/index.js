    ...
    <Row>
      <Col className="my-2" lg="4" md="6" sm="12">
        <Card>
          <Card.Header className="text-center">
            {' '}
            <img className="darkModeLogo" src={Immunefi} alt="immunefi" />
            <img className="lightModeLogo" src={ImmunefiDark} alt="immunefi" />
          </Card.Header>
          <Card.Body style={{ minHeight: '84px' }}>
            Web3&apos;s leading bug bounty platform, protecting $100 billion in
            user funds.
          </Card.Body>
          <Card.Footer>
            <a
      ...
      <Col className="my-2" lg="4" md="6" sm="12">
        <Card>
          ...
          <Card.Body style={{ minHeight: '84px' }}>
            Utilizing best-in-class AI technology to secure & monitor blockchain
      ...
      <Col className="my-2" lg="4" md="6" sm="12">
        <Card>
          ...
          <Card.Body style={{ minHeight: '84px' }}>
            Everything built by the community is open source! GitHub is critical
            to enabling such transparency.
          </Card.Body>
          <Card.Footer>
            <a
      ...
      <Col className="my-2" lg="4" md="6" sm="12">
        <Card>
          ...
          <Card.Body style={{ minHeight: '84px' }}>
            Decentralized, cross-chain wallet, allowing users to securely manage
            their identities, data, & digital assets.
          </Card.Body>
          <Card.Footer>
